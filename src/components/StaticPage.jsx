...
const staticContent = {
  ...
  kg: {
    modifyBooking: { title: 'Бронилоону өзгөртүү', content: 'Бронилоо даталарын же деталдарын өзгөртүү үчүн колдоого кайрылыңыз.' },
    cancelBooking: { title: 'Бронилоону жокко чыгаруу', content: 'Алмашуудан 48 саат мурун жокко чыгаруу - толук кайтарым.' },
    aboutUs: { title: 'Биз жөнүндө', content: 'CWD 2000-жылдан бери Борбордук Азиянын лидер ижарасы.' },
    feedback: { title: 'Пикир', content: 'Бизди жакшыртуу үчүн тажрыйбаңызды бөлүшүңүз.' },
    destinations: { title: 'Жолдор', content: 'Кыргызстан жана Казакстандын бардык жерлеринде ижара.' },
